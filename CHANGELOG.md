...
### Fixed
- Lowercased brand name in setting description to pass sentence case scanner

## [1.0.5] - 2026-02-10

### Fixed
- Removed filename reference (`KoboReader.sqlite`) from setting description to avoid capitalization flag
- Rephrased command reference in instructions to avoid quoted capitalized text

## [1.0.4] - 2026-02-10

### Fixed
- Resolved all remaining sentence case violations in UI text
- Removed redundant plugin name from command and heading labels
- Simplified setting descriptions to avoid mid-text capitalization

## [1.0.3] - 2026-02-10

### Fixed
- Removed "General settings" heading from settings (violates Obsidian guidelines)
- Applied sentence case to remaining UI labels: "Page metadata", "Highlight format", "New highlights header"
- Fixed promise void in textarea event listener
